...
<div class="form-card">
    ...
    <form method="POST" action="{{ route('admin.users.update', $user) }}">
        ...
        {{-- Rôles — 4 cartes avec icônes Bootstrap --}}
        <div class="form-group">
            ...
            <div class="role-cards" id="roleCards">
                ...
                @foreach($roles as $val => $info)
                    <label class="role-card-select" id="card-{{ $val }}">
        ...
        <div class="form-group">
            <label class="form-label-premium">
                ...
                <span style="color:#94a3b8; font-weight:400; text-transform:none; letter-spacing:0;">
                    (laisser vide pour ne pas changer)
                </span>
            </label>
            <input type="password" name="password"
                   class="form-input-premium {{ $errors->has('password') ? 'is-invalid' : '' }}"
                   placeholder="Laisser vide pour conserver l'actuel">
            @error('password') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>

        <div class="form-group">
            <label class="form-label-premium">Confirmer le nouveau mot de passe</label>
